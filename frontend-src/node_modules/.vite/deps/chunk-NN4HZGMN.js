...
var DirectionProvider = function DirectionProvider2(props) {
  ...
  return (0, import_jsx_runtime.jsx)(DirectionContext.Provider, {
    value: contextValue,
...
function usePopupViewport(parameters) {
  ...
  const capturedNodeRef = React3.useRef(null);
  const [previousContentNode, setPreviousContentNode] = React3.useState(null);
  const [newTriggerOffset, setNewTriggerOffset] = React3.useState(null);
  const currentContainerRef = React3.useRef(null);
  const previousContainerRef = React3.useRef(null);
  const onAnimationsFinished = useAnimationsFinished(currentContainerRef, true, false);
  const cleanupFrame = useAnimationFrame();
  const [previousContentDimensions, setPreviousContentDimensions] = React3.useState(null);
  const [showStartingStyleAttribute, setShowStartingStyleAttribute] = React3.useState(false);
  useIsoLayoutEffect(() => {
  ...
  const lastHandledTriggerRef = React3.useRef(null);
  useIsoLayoutEffect(() => {
  ...
  if (!isTransitioning) {
    childrenToRender = (0, import_jsx_runtime2.jsx)("div", {
      "data-current": true,
      ref: currentContainerRef,
      children
    }, currentContentKey);
  } else {
    childrenToRender = (0, import_jsx_runtime2.jsxs)(React3.Fragment, {
      ...
      }, "previous"), (0, import_jsx_runtime2.jsx)("div", {
        "data-current": true,
        ref: currentContainerRef,
...
function usePopupContentKey(activeTriggerId, payload) {
  const [contentKey, setContentKey] = React3.useState(0);
  const previousActiveTriggerIdRef = React3.useRef(activeTriggerId);
  const previousPayloadRef = React3.useRef(payload);
  const pendingPayloadUpdateRef = React3.useRef(false);
  useIsoLayoutEffect(() => {
...
//# sourceMappingURL=chunk-NN4HZGMN.js.map
