...
var SwitchRoot = React2.forwardRef(function SwitchRoot2(componentProps, forwardedRef) {
  ...
  const inputProps = React2.useMemo(() => mergeProps(
    {
      ...
      onFocus() {
        var _a;
        (_a = switchRef.current) == null ? void 0 : _a.focus();
      }
    },
  ...
  ), [checked, disabled, form, handleInputRef, hiddenInputId, name, onCheckedChange, readOnly, required, setCheckedState, validation, value]);
