...
var TooltipProviderContext = React4.createContext(void 0);
...
var TooltipPortalContext = React6.createContext(void 0);
...
var FloatingPortalLite = React7.forwardRef(function FloatingPortalLite2(componentProps, forwardedRef) {
  const {
    children,
    container,
    className,
  ...
  return (0, import_jsx_runtime2.jsxs)(React7.Fragment, {
    children: [portalSubtree, portalNode && ReactDOM2.createPortal(children, portalNode)]
  });
});
...
var TooltipPortal = React8.forwardRef(function TooltipPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
  ...
  return (0, import_jsx_runtime3.jsx)(TooltipPortalContext.Provider, {
    value: keepMounted,
    children: (0, import_jsx_runtime3.jsx)(FloatingPortalLite, {
      ref: forwardedRef,
      ...portalProps
    })
  });
...
var TooltipPositionerContext = React9.createContext(void 0);
if (true) TooltipPositionerContext.displayName = "TooltipPositionerContext";
function useTooltipPositionerContext() {
  const context = React9.useContext(TooltipPositionerContext);
  if (context === void 0) {
...
var TooltipPositioner = React10.forwardRef(function TooltipPositioner2(componentProps, forwardedRef) {
  const {
    render,
    className,
    anchor,
  ...
  return (0, import_jsx_runtime4.jsx)(TooltipPositionerContext.Provider, {
    value: positioning,
    children: element
  });
});
...
var TooltipPopup = React11.forwardRef(function TooltipPopup2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
...
var TooltipArrow = React12.forwardRef(function TooltipArrow2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
...
var TooltipProvider = function TooltipProvider2(props) {
  ...
  const delayValue = React13.useMemo(() => ({
    open: delay,
    close: closeDelay
  }), [delay, closeDelay]);
  return (0, import_jsx_runtime5.jsx)(TooltipProviderContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime5.jsx)(FloatingDelayGroup, {
      delay: delayValue,
      timeoutMs: timeout,
...
var TooltipViewport = React14.forwardRef(function TooltipViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
