...
function fastComponentRef(fn) {
  return React2.forwardRef(fastComponent(fn));
}
...
var FloatingPortal = React8.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  ...
  const focusInsideDisabledRef = React8.useRef(false);
...
function FloatingNode(props) {
  ...
  const parentId = useFloatingParentNodeId();
  return (0, import_jsx_runtime5.jsx)(FloatingNodeContext.Provider, {
...
function FloatingTree(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(FloatingTreeContext.Provider, {
    value: tree,
    children
  });
}
...
function FloatingFocusManager(props) {
  ...
  const lastFocusedTabbableRef = React10.useRef(null);
...
function useClientPoint(context, props = {}) {
  ...
  const initialRef = React12.useRef(false);
  const cleanupListenerRef = React12.useRef(null);
  const [pointerType, setPointerType] = React12.useState();
  const [reactive, setReactive] = React12.useState([]);
  ...
  const addListener = React12.useCallback(() => {
...
function useTriggerRegistration(id, store) {
  const registeredElementIdRef = React15.useRef(null);
  const registeredElementRef = React15.useRef(null);
  return React15.useCallback((element) => {
    if (id === void 0) {
      return;
    }
...
function useFocus(context, props = {}) {
  ...
  const blockedReferenceRef = React16.useRef(null);
  const timeout = useTimeout();
...
function useHoverFloatingInteraction(context, parameters = {}) {
  ...
  const closeWithDelay = React17.useCallback((event) => {
...
function useHoverReferenceInteraction(context, props = {}) {
  ...
  const tree = useFloatingTree(externalTree);
  const instance = useHoverInteractionSharedState(store);
  const isHoverCloseActiveRef = React18.useRef(false);
  ...
  React18.useEffect(() => cleanupMouseMoveHandler, [cleanupMouseMoveHandler]);
  React18.useEffect(() => {
    if (!enabled) {
      return void 0;
    }
...
function useListNavigation(context, props) {
  ...
  const cancelQueuedFocusRef = React20.useRef(null);
...
function useRole(context, props = {}) {
  ...
  const floatingId = React21.useMemo(() => {
    var _a;
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ID3MLXW2.js.map
