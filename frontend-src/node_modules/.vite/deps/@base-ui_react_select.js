...
} from "./chunk-IJIIKKOA.js";
import {
  useCSPContext
} from "./chunk-WZLWRJ3N.js";
import {
...
import {
  useValueAsRef
} from "./chunk-MCYUJDQE.js";
import "./chunk-UO2BPYBL.js";
import {
  addEventListener
} from "./chunk-X5MJPOE4.js";
import {
  useLabel
} from "./chunk-KTHIL4W3.js";
import "./chunk-LL2YRYFG.js";
import {
  useLabelableId
} from "./chunk-JER3AHGC.js";
import {
  contains,
...
var SelectRootContext = React.createContext(null);
if (true) SelectRootContext.displayName = "SelectRootContext";
var SelectFloatingContext = React.createContext(null);
...
function resolveMultipleLabels(values, items, itemToStringLabel) {
  return values.reduce((acc, value, index) => {
    ...
    acc.push((0, import_jsx_runtime.jsx)(React2.Fragment, {
...
// node_modules/@base-ui/react/esm/select/label/SelectLabel.js
var SelectLabel = React4.forwardRef(function SelectLabel2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var SelectTrigger = React5.forwardRef(function SelectTrigger2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var SelectValue = React6.forwardRef(function SelectValue2(componentProps, forwardedRef) {
  const {
    className,
    render,
...
var SelectIcon = React7.forwardRef(function SelectIcon2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
...
var SelectPortalContext = React8.createContext(void 0);
if (true) SelectPortalContext.displayName = "SelectPortalContext";

// node_modules/@base-ui/react/esm/select/portal/SelectPortal.js
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var SelectPortal = React9.forwardRef(function SelectPortal2(portalProps, forwardedRef) {
  const {
    store
  } = useSelectRootContext();
...
var SelectBackdrop = React10.forwardRef(function SelectBackdrop2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
...
var SelectPositionerContext = React11.createContext(void 0);
...
var SelectPositioner = React12.forwardRef(function SelectPositioner2(componentProps, forwardedRef) {
  const {
    anchor,
...
var SelectPopup = React13.forwardRef(function SelectPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  return (0, import_jsx_runtime5.jsxs)(React13.Fragment, {
    children: [!disableStyleElements && styleDisableScrollbar.getElement(nonce), (0, import_jsx_runtime5.jsx)(FloatingFocusManager, {
...
var SelectList = React14.forwardRef(function SelectList2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
...
var SelectItemContext = React15.createContext(void 0);
...
var SelectItem = React16.memo(React16.forwardRef(function SelectItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
...
var SelectItemIndicator = React17.forwardRef(function SelectItemIndicator2(componentProps, forwardedRef) {
...
var Inner = React17.memo(React17.forwardRef((componentProps, forwardedRef) => {
  const {
    render,
    className,
    style,
...
var SelectItemText = React18.memo(React18.forwardRef(function SelectItemText2(componentProps, forwardedRef) {
  const {
    indexRef,
    textRef,
    selectedByFocus,
...
var SelectArrow = React19.forwardRef(function SelectArrow2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
...
var SelectScrollArrow = React20.forwardRef(function SelectScrollArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var SelectScrollDownArrow = React21.forwardRef(function SelectScrollDownArrow2(props, forwardedRef) {
...
var SelectScrollUpArrow = React22.forwardRef(function SelectScrollUpArrow2(props, forwardedRef) {
...
var SelectGroupContext = React23.createContext(void 0);
...
var SelectGroup = React24.forwardRef(function SelectGroup2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
...
var SelectGroupLabel = React25.forwardRef(function SelectGroupLabel2(componentProps, forwardedRef) {
  const {
    className,
    render,
    id: idProp,
