...
import {
  error
} from "./chunk-HQPNHHNY.js";
import "./chunk-SOOTWIXL.js";
import {
  useBaseUiId
...
// node_modules/@base-ui/react/esm/field/root/useFieldControlRegistration.js
...
function useFieldControlRegistration(params) {
  ...
  const activeFieldControlSourceRef = React4.useRef(null);
  const registrationRef = React4.useRef(null);
  const fallbackControlRef = React4.useRef(null);
...
var FieldRootInner = React5.forwardRef(function FieldRootInner2(componentProps, forwardedRef) {
  const {
    errors,
  ...
  const [touchedState, setTouchedUnwrapped] = React5.useState(false);
  const [dirtyState, setDirtyUnwrapped] = React5.useState(false);
  const [filled, setFilled] = React5.useState(false);
  const [focused, setFocused] = React5.useState(false);
  const dirty = dirtyProp ?? dirtyState;
  const touched = touchedProp ?? touchedState;
  const markedDirtyRef = React5.useRef(false);
  ...
  const [validityData, setValidityData] = React5.useState({
  ...
  const handleImperativeValidate = React5.useCallback(() => {
    markedDirtyRef.current = true;
...
var FieldRoot = React5.forwardRef(function FieldRoot2(componentProps, forwardedRef) {
...
var FieldLabel = React6.forwardRef(function FieldLabel2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const labelRef = React6.useRef(null);
...
var FieldError = React7.forwardRef(function FieldError2(componentProps, forwardedRef) {
  const {
    render,
    id: idProp,
    className,
  ...
  const errorRef = React7.useRef(null);
  const [lastRenderedMessage, setLastRenderedMessage] = React7.useState(null);
  const [lastRenderedMessageKey, setLastRenderedMessageKey] = React7.useState(null);
...
var FieldDescription = React8.forwardRef(function FieldDescription2(componentProps, forwardedRef) {
  const {
    render,
    id: idProp,
    className,
...
var FieldControl = React9.forwardRef(function FieldControl2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var FieldValidity = function FieldValidity2(props) {
  ...
  const combinedFieldValidityData = React10.useMemo(() => getCombinedFieldValidityData(validityData, invalid), [validityData, invalid]);
  const isInvalid = combinedFieldValidityData.state.valid === false;
  const {
    transitionStatus
  } = useTransitionStatus(isInvalid);
  const fieldValidityState = React10.useMemo(() => {
    return {
  ...
  return (0, import_jsx_runtime4.jsx)(React10.Fragment, {
...
var FieldItem = React11.forwardRef(function FieldItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const fieldItemContext = React11.useMemo(() => ({
    disabled
  }), [disabled]);
  const element = useRenderElement("div", componentProps, {
    ref: forwardedRef,
...
var Input = React12.forwardRef(function Input2(props, forwardedRef) {
