...
exports.AutocompleteTriggerDataAttributes = void 0;
var _popupStateMapping = require("../../utils/popupStateMapping");
let AutocompleteTriggerDataAttributes = exports.AutocompleteTriggerDataAttributes = function (AutocompleteTriggerDataAttributes) {
  /**
   * Present when the corresponding popup is open.
   */
  AutocompleteTriggerDataAttributes[AutocompleteTriggerDataAttributes["popupOpen"] = _popupStateMapping.CommonTriggerDataAttributes.popupOpen] = "popupOpen";
  /**
   * Present when the trigger is pressed.
   */
  AutocompleteTriggerDataAttributes[AutocompleteTriggerDataAttributes["pressed"] = _popupStateMapping.CommonTriggerDataAttributes.pressed] = "pressed";
  /**
