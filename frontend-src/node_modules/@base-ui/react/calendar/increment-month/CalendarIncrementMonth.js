...
exports.CalendarIncrementMonth = void 0;
 ...
 */
const CalendarIncrementMonth = exports.CalendarIncrementMonth = /*#__PURE__*/React.forwardRef(function CalendarIncrementMonth(componentProps, forwardedRef) {
  const {
    className,
    render,
    nativeButton,
...
if (process.env.NODE_ENV !== "production") CalendarIncrementMonth.displayName = "CalendarIncrementMonth";