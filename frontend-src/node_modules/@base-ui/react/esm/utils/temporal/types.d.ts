import { TemporalTimezone, TemporalSupportedValue, TemporalSupportedObject } from "../../types/temporal/index.js";
 ...
 */
export interface TemporalManager<TValue extends TemporalSupportedValue, TError, TValidationProps extends {}> {
  /**
