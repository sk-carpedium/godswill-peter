...
var _shadowDom = require("../../floating-ui-react/utils/shadowDom");
...
const OTPFieldRoot = exports.OTPFieldRoot = /*#__PURE__*/React.forwardRef(function OTPFieldRoot(componentProps, forwardedRef) {
  ...
  const handleInputBlur = (0, _useStableCallback.useStableCallback)(event => {
    if ((0, _shadowDom.contains)(rootRef.current, event.relatedTarget)) {
      return;
    }
    setTouched(true);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_CompositeList.CompositeList, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_OTPFieldRootContext.OTPFieldRootContext.Provider, {
      value: contextValue,
      children: [element, /*#__PURE__*/(0, _jsxRuntime.jsx)(OTPFieldHiddenInput, {
...
function OTPFieldHiddenInput(props) {
  const {
    autoComplete,
    disabled,
    focusInput,
    ...
    ...validation.getInputValidationProps({
      ...
      onChange(event) {
        ...
        if ((0, _otp.stripOTPWhitespace)(rawValue).length > normalizedValue.length) {
          onValueInvalid(rawValue, (0, _createBaseUIEventDetails.createGenericEventDetails)(_reasons.REASONS.inputChange, event.nativeEvent));
        }
