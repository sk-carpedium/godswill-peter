    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Link to={createPageUrl('Settings')}>
          <Button size="sm" className="bg-[#d4af37] hover:bg-[#c49f2f] text-slate-950">
      ...
      <CardContent className="space-y-3">
        {accounts.length === 0 ? (
          ...
          accounts.map((account) => {
            const config = platformConfig[account.platform] || { name: account.platform, svg: null };
            const isHealthy = account.health_status === 'healthy';

            return (
              <div
                key={account.id}
                className="flex items-center gap-3 p-3 rounded-xl border border-slate-200 hover:border-[#d4af37]/30 hover:shadow-sm transition-all"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <Button 
                    ...
                    onClick={() => console.log('Refresh account:', account.id)}
                  >
