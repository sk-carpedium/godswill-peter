  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">TikTok Management</h1>
          <p className="text-slate-500">Manage comments, DMs, analytics, and followers</p>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="comments" className="mt-6"><CommentsManager platformName="TikTok" platformColor="slate" /></TabsContent>
        <TabsContent value="messages" className="mt-6"><DirectMessages platformName="TikTok" platformColor="slate" /></TabsContent>
        <TabsContent value="analytics" className="mt-6"><PlatformAnalytics platformName="TikTok" platformColor="slate" /></TabsContent>
        <TabsContent value="audience" className="mt-6"><AudienceEngagement platformName="TikTok" platformColor="slate" /></TabsContent>
      </Tabs>
    </div>
  );
}