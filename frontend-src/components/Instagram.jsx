  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Instagram Management</h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="comments" className="mt-6"><CommentsManager platformName="Instagram" platformColor="purple" /></TabsContent>
        <TabsContent value="messages" className="mt-6"><DirectMessages platformName="Instagram" platformColor="purple" /></TabsContent>
        <TabsContent value="analytics" className="mt-6"><PlatformAnalytics platformName="Instagram" platformColor="purple" /></TabsContent>
        <TabsContent value="audience" className="mt-6"><AudienceEngagement platformName="Instagram" platformColor="purple" /></TabsContent>
      </Tabs>
    </div>);
